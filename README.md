...
1) Add routing - modify your server-side code in `index.js` to support routing. Make sure you also add an `about.ejs` and a `projects.ejs` to [views/pages](https://github.com/zsobin/PersonalWebApp/tree/master/views/pages). [See index.js code here](https://github.com/zsobin/PersonalWebApp/blob/master/index.js#L13-L23)
